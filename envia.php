<?php
if(!isset($_POST[envia])) die("<p>Obrigado pelo contato! <a href='".$_SERVER["HTTP_REFERER"]."'>Voltar</a></p>");
/* Medida preventiva para evitar que outros domínios sejam remetente da sua mensagem. */
if (eregi('sofertech.esy.es$', $_SERVER[HTTP_HOST])) {
        $emailsender='vitor.rocha81@bol.com.br';
} else {
...
$emaildestinatario = "vitor.rocha81@bol.com.br";
